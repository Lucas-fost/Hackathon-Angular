...
var SignupComponent = (function () {
    ...
    SignupComponent.prototype.handleSignup = function (event) {
        var _this = this;
        event.preventDefault();
...
var UserService = (function () {
    ...
    UserService.prototype.getMembers = function () {
        return this.http.get(this.api + "api/members");
    };
    UserService.prototype.getMember = function (id) {
        return this.http.get(this.api + "api/members/member/" + id);
    };
    return UserService;
}());
