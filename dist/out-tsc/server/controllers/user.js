...
var randomBytesAsync = exports.promisify(crypto.randomBytes);
/**
...
exports.getVerifyEmail = function (req, res, next) {
    ...
    var sendVerifyEmail = function (token) {
        var mailOptions = {
            to: req.user.email,
    ...
    createRandomToken
        ...
        .then(function () { return res.redirect('/account'); })
        .catch(next);
};
/**
 * POST /reset/:token
...
exports.checkAuth = function (req, res) { return req.isAuthenticated() ? res.json({ auth: true }) : res.json({ auth: false }); };
